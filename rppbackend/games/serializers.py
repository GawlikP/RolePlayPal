...
class GameListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','slug','created','game_master', 'edited','next_game','description','name','players','get_image']
...
class GameInvitationListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','created','edited','game_master_sender','game','game_slug','player','text','readed','accepted','hide']
...
class GameInvitationPostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','created','edited','game_master_sender','game_master_sender_username','game_master_sender_slug','game','game_slug','player','player_slug','text','readed','accepted','hide','get_absolute_url']
